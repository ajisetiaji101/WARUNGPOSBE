        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    sh 'cd /var/lib/jenkins/workspace/WARUNGPOSBE/target && BUILD_ID=dontKillMe nohup java -jar warungposbe-0.0.1-SNAPSHOT.jar > /var/lib/jenkins/workspace/WARUNGPOSBE/nohup.out 2>&1'
                }
            }
        }
    }
